...
//
module pixfifo(i_wr_clk, i_rd_clk, i_wr, i_data, i_rd, o_data);
	...
	wire	[(LGFLEN-1):0]	w_rd_first, w_wr_last;

	wire	[(LGFLEN-1):0]	w_first_plus_one, w_last_plus_one;
