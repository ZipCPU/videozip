...
module	toplevel(i_clk,
	...
	main	thedesign(s_clk, s_reset,
		...
		i_gps_pps,
		o_net_reset_n,
		i_net_rx_clk, w_net_rxctlp, w_net_rxd,
		i_net_rx_clk, w_net_txctl, w_net_txd,
		// HDMI output ports
	...
	xiddr	rxc(i_net_rx_clk, i_net_rx_ctl, { w_net_rxctlp, w_net_rxctln });

	xoddr	tx0(i_net_rx_clk, { w_net_txd[0], w_net_txd[4] }, o_net_txd[0]);
	xoddr	tx1(i_net_rx_clk, { w_net_txd[1], w_net_txd[5] }, o_net_txd[1]);
	xoddr	tx2(i_net_rx_clk, { w_net_txd[2], w_net_txd[6] }, o_net_txd[2]);
	xoddr	tx3(i_net_rx_clk, { w_net_txd[3], w_net_txd[7] }, o_net_txd[3]);
	xoddr	txc(i_net_rx_clk, { w_net_txctl,  w_net_txctl  }, o_net_tx_ctl);
	xoddr	txck(i_net_rx_clk,{ 1'b1,  1'b0  }, o_net_tx_clk);
