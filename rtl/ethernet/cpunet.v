////////////////////////////////////////////////////////////////////////////////
//
// Filename:	rtl/ethernet/cpunet.v
// {{{
...
module	cpunet #(
	...
	// The front end ethernet stream takes care of these checks before
	// we get here.

	assign	my_valid = RX_VALID;
	assign	RX_READY = my_ready;
	assign	my_data  = RX_DATA;
	assign	my_bytes = RX_BYTES;
	assign	my_last  = RX_LAST;
	assign	my_abort = RX_ABORT;
	...
	// Rearrange the packet from whatever width it came in on to the
	// width of the Wishbone/memory bus
