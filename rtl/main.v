...
// }}}
	...
	wire	sdwbscope_int;	// sdwbscope.INT.SDWBSCOPE.WIRE
...
// }}}
	...
	// Verilator lint_on UNUSED
	// Wishbone definitions for bus wb32, component sdwbscope
	// Verilator lint_off UNUSED
	wire		wb32_sdwbscope_cyc, wb32_sdwbscope_stb, wb32_sdwbscope_we;
	wire	[11:0]	wb32_sdwbscope_addr;
	wire	[31:0]	wb32_sdwbscope_data;
	wire	[3:0]	wb32_sdwbscope_sel;
	wire		wb32_sdwbscope_stall, wb32_sdwbscope_ack, wb32_sdwbscope_err;
	wire	[31:0]	wb32_sdwbscope_idata;
	// Verilator lint_on UNUSED
	// Wishbone definitions for bus wb32, component vidscope
	// Verilator lint_off UNUSED
	wire		wb32_vidscope_cyc, wb32_vidscope_stb, wb32_vidscope_we;
	wire	[11:0]	wb32_vidscope_addr;
	...
	assign	wb32_rotary_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h8);  // 0x020
	...
	assign	wb32_rtccount_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h9);  // 0x024
	...
	assign	wb32_rtcdate_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'ha);  // 0x028
	...
	assign	wb32_spio_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'hb);  // 0x02c
	...
	assign	wb32_sysclk_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'hc);  // 0x030
	...
	assign	wb32_version_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'hd);  // 0x034
	...
	assign	wb32_edids_stb = wb32_dio_stb && ((wb32_dio_addr[ 6: 3] &  4'hf) ==  4'h0);  // 0x000 - 0x00f
	...
	assign	wb32_i2cs_stb = wb32_dio_stb && ((wb32_dio_addr[ 6: 3] &  4'hf) ==  4'h1);  // 0x020 - 0x02f
	...
	assign	wb32_oled_stb = wb32_dio_stb && ((wb32_dio_addr[ 6: 3] &  4'hf) ==  4'h2);  // 0x040 - 0x04f
	...
	assign	wb32_rtc_stb = wb32_dio_stb && ((wb32_dio_addr[ 6: 3] &  4'hf) ==  4'h3);  // 0x060 - 0x07f
	...
	assign	wb32_sio_stb = wb32_dio_stb && ((wb32_dio_addr[ 6: 3] &  4'he) ==  4'h4);  // 0x080 - 0x0bf
	...
	assign	wb32_edidslv_stb = wb32_dio_stb && ((wb32_dio_addr[ 6: 3] &  4'h8) ==  4'h8);  // 0x100 - 0x1ff
	...
	assign	wb32_sdwbscope_err= 1'b0;
	...
	wbxbar #(
		...
		.SLAVE_ADDR({
			...
			{ 12'h480 }, //          cfg: 0x1200
			{ 12'h400 }, //         uart: 0x1000
			{ 12'h380 }, //     zipscope: 0x0e00
			{ 12'h300 }, //     vidscope: 0x0c00
			{ 12'h280 }, //    sdwbscope: 0x0a00
			{ 12'h200 }, //    sdioscope: 0x0800
...
`ifdef	SDIOSCOPE_SCOPC
	...
	wbscopc #(
		...
		// {{{
		.i_data_clk(i_clk), .i_ce(1'b1),
		.i_trigger(i_sdio_debug[31]), .i_data(i_sdio_debug[30:0]),
		.i_wb_clk(i_clk),
...
`ifdef	SDWBSCOPE_SCOPC
	...
	wbscopc #(
		...
		// {{{
		.i_data_clk(i_clk), .i_ce(1'b1),
		.i_trigger(w_sdio_sdwb_debug[31]), .i_data(w_sdio_sdwb_debug[30:0]),
		.i_wb_clk(i_clk),
		.i_wb_cyc(wb32_sdwbscope_cyc), .i_wb_stb(wb32_sdwbscope_stb), .i_wb_we(wb32_sdwbscope_we),
			.i_wb_addr(wb32_sdwbscope_addr[1-1:0]),
			.i_wb_data(wb32_sdwbscope_data), // 32 bits wide
			.i_wb_sel(wb32_sdwbscope_sel),  // 32/8 bits wide
		.o_wb_stall(wb32_sdwbscope_stall),.o_wb_ack(wb32_sdwbscope_ack), .o_wb_data(wb32_sdwbscope_idata),
		.o_interrupt(sdwbscope_int)
		// }}}
	);
	// }}}
`else	// SDWBSCOPE_SCOPC
	// {{{
	// Null bus slave
	// {{{

	//
	// In the case that there is no wb32_sdwbscope peripheral
	// responding on the wb32 bus
	assign	wb32_sdwbscope_ack   = 1'b0;
	assign	wb32_sdwbscope_err   = (wb32_sdwbscope_stb);
	assign	wb32_sdwbscope_stall = 0;
	assign	wb32_sdwbscope_idata = 0;

	// }}}
	// Null interrupt definitions
	// {{{
	assign	sdwbscope_int = 1'b0;	// sdwbscope.INT.SDWBSCOPE.WIRE
	// }}}
	// }}}
`endif	// SDWBSCOPE_SCOPC
