...
// Deplist for @$(PREFIX)=spiscope
`ifdef	OLEDBW_ACCESS
`define	SPISCOPE_SCOPC
`endif	// OLEDBW_ACCESS
// Deplist for @$(PREFIX)=vidscope
`ifdef	VIDPIPE_ACCESS
`define	VIDSCOPE_SCOPE
...
// }}}
	...
	wire	vidscope_int;	// vidscope.INT.VIDSCOPE.WIRE
	wire	spiscope_int;	// spiscope.INT.OLEDSCOPE.WIRE
...
// }}}
	...
	wire	[12:0]	wb32_netclockctr_addr;
	...
	// Verilator lint_on UNUSED
	// Wishbone definitions for bus wb32(SIO), component rotary
	// Verilator lint_off UNUSED
	wire		wb32_rotary_cyc, wb32_rotary_stb, wb32_rotary_we;
	wire	[12:0]	wb32_rotary_addr;
	wire	[31:0]	wb32_rotary_data;
	wire	[3:0]	wb32_rotary_sel;
	wire		wb32_rotary_stall, wb32_rotary_ack, wb32_rotary_err;
	wire	[31:0]	wb32_rotary_idata;
	// Verilator lint_on UNUSED
	...
	// Verilator lint_on UNUSED
	// Wishbone definitions for bus wb32, component spiscope
	// Verilator lint_off UNUSED
	wire		wb32_spiscope_cyc, wb32_spiscope_stb, wb32_spiscope_we;
	wire	[12:0]	wb32_spiscope_addr;
	wire	[31:0]	wb32_spiscope_data;
	wire	[3:0]	wb32_spiscope_sel;
	wire		wb32_spiscope_stall, wb32_spiscope_ack, wb32_spiscope_err;
	wire	[31:0]	wb32_spiscope_idata;
	// Verilator lint_on UNUSED
	// Wishbone definitions for bus wb32, component vidscope
	// Verilator lint_off UNUSED
	wire		wb32_vidscope_cyc, wb32_vidscope_stb, wb32_vidscope_we;
	wire	[12:0]	wb32_vidscope_addr;
	wire	[31:0]	wb32_vidscope_data;
	wire	[3:0]	wb32_vidscope_sel;
	wire		wb32_vidscope_stall, wb32_vidscope_ack, wb32_vidscope_err;
	wire	[31:0]	wb32_vidscope_idata;
	// Verilator lint_on UNUSED
	// Wishbone definitions for bus wb32, component zipscope
	// Verilator lint_off UNUSED
	wire		wb32_zipscope_cyc, wb32_zipscope_stb, wb32_zipscope_we;
	wire	[12:0]	wb32_zipscope_addr;
	...
	4'h8: r_wb32_sio_data <= wb32_rotary_idata;
	4'h9: r_wb32_sio_data <= wb32_rtccount_idata;
	4'ha: r_wb32_sio_data <= wb32_rtcdate_idata;
	4'hb: r_wb32_sio_data <= wb32_spio_idata;
	4'hc: r_wb32_sio_data <= wb32_sysclk_idata;
	4'hd: r_wb32_sio_data <= wb32_version_idata;
	...
	assign	wb32_buserr_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h1);  // 0x0004
	...
	assign	wb32_genclk_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h2);  // 0x0008
	...
	assign	wb32_genclkfb_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h3);  // 0x000c
	...
	assign	wb32_gpio_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h4);  // 0x0010
	...
	assign	wb32_netclockctr_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h5);  // 0x0014
	...
	assign	wb32_nettxctr_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h6);  // 0x0018
	...
	assign	wb32_pwrcount_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h7);  // 0x001c
	assign	wb32_pwrcount_we  = wb32_sio_we;
	assign	wb32_pwrcount_data= wb32_sio_data;
	assign	wb32_pwrcount_sel = wb32_sio_sel;
	assign	wb32_rotary_cyc = wb32_sio_cyc;
	assign	wb32_rotary_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h8);  // 0x0020
	assign	wb32_rotary_we  = wb32_sio_we;
	assign	wb32_rotary_data= wb32_sio_data;
	assign	wb32_rotary_sel = wb32_sio_sel;
	assign	wb32_rtccount_cyc = wb32_sio_cyc;
	assign	wb32_rtccount_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'h9);  // 0x0024
	...
	assign	wb32_rtcdate_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'ha);  // 0x0028
	...
	assign	wb32_spio_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'hb);  // 0x002c
	...
	assign	wb32_sysclk_stb = wb32_sio_stb && (wb32_sio_addr[ 3: 0] ==  4'hc);  // 0x0030
	...
	always @(posedge i_clk)
	casez(wb32_dio_addr[6:3])
	4'b0_000: r_wb32_dio_bus_select <= 3'd0;
	4'b0_001: r_wb32_dio_bus_select <= 3'd1;
	4'b0_010: r_wb32_dio_bus_select <= 3'd2;
	4'b0_011: r_wb32_dio_bus_select <= 3'd3;
	4'b0_10?: r_wb32_dio_bus_select <= 3'd4;
	4'b1_???: r_wb32_dio_bus_select <= 3'd5;
	...
	3'd2: r_wb32_dio_data <= wb32_oled_idata;
	3'd3: r_wb32_dio_data <= wb32_rtc_idata;
	3'd4: r_wb32_dio_data <= wb32_sio_idata;
	3'd5: r_wb32_dio_data <= wb32_edidslv_idata;
	...
	assign	wb32_edids_stb = wb32_dio_stb && ((wb32_dio_addr[ 6: 3] &  4'hf) ==  4'h0);  // 0x0000 - 0x000f
	...
	assign	wb32_i2cs_stb = wb32_dio_stb && ((wb32_dio_addr[ 6: 3] &  4'hf) ==  4'h1);  // 0x0020 - 0x002f
	...
	assign	wb32_oled_stb = wb32_dio_stb && ((wb32_dio_addr[ 6: 3] &  4'hf) ==  4'h2);  // 0x0040 - 0x004f
	...
	assign	wb32_rtc_stb = wb32_dio_stb && ((wb32_dio_addr[ 6: 3] &  4'hf) ==  4'h3);  // 0x0060 - 0x007f
	...
	assign	wb32_sio_stb = wb32_dio_stb && ((wb32_dio_addr[ 6: 3] &  4'he) ==  4'h4);  // 0x0080 - 0x00bf
	...
	assign	wb32_edidslv_stb = wb32_dio_stb && ((wb32_dio_addr[ 6: 3] &  4'h8) ==  4'h8);  // 0x0100 - 0x01ff
	...
	//
	wbxbar #(
		.NM(1), .NS(10), .AW(13), .DW(32),
		.SLAVE_ADDR({
			// Address width    = 13
			// Address LSBs     = 2
			{ 13'h1000 }, //     mdio: 0x4000
			{ 13'h0c00 }, //     hdmi: 0x3000
			{ 13'h0800 }, // wb32_dio: 0x2000
			{ 13'h0700 }, //      net: 0x1c00
			{ 13'h0600 }, //      cfg: 0x1800
			{ 13'h0500 }, //     uart: 0x1400
			{ 13'h0400 }, // zipscope: 0x1000
			{ 13'h0300 }, // vidscope: 0x0c00
			{ 13'h0200 }, // spiscope: 0x0800
			{ 13'h0100 }  // flashcfg: 0x0400
		}),
		.SLAVE_MASK({
			// Address width    = 13
			// Address LSBs     = 2
...
`ifdef	OLEDBW_ACCESS
	...
	spicpu #(
		...
		.o_pf_cyc(wbwide_oledm_cyc), .o_pf_stb(wbwide_oledm_stb), .o_pf_we(wbwide_oledm_we),
			.o_pf_addr(wbwide_oledm_addr[26-1:0]),
...
`ifdef	VIDSCOPE_SCOPE
	...
	wbscope #(
		...
		.i_wb_clk(i_clk),
		.i_wb_cyc(wb32_vidscope_cyc), .i_wb_stb(wb32_vidscope_stb), .i_wb_we(wb32_vidscope_we),
			.i_wb_addr(wb32_vidscope_addr[1-1:0]),
			.i_wb_data(wb32_vidscope_data), // 32 bits wide
			.i_wb_sel(wb32_vidscope_sel),  // 32/8 bits wide
		.o_wb_stall(wb32_vidscope_stall),.o_wb_ack(wb32_vidscope_ack), .o_wb_data(wb32_vidscope_idata),
...
`else	// VIDSCOPE_SCOPE
	...
	//
	// In the case that there is no wb32_vidscope peripheral
	// responding on the wb32 bus
	assign	wb32_vidscope_ack   = 1'b0;
	assign	wb32_vidscope_err   = (wb32_vidscope_stb);
	assign	wb32_vidscope_stall = 0;
	assign	wb32_vidscope_idata = 0;

	// }}}
	// Null interrupt definitions
	// {{{
	assign	vidscope_int = 1'b0;	// vidscope.INT.VIDSCOPE.WIRE
	// }}}
	// }}}
...
`ifdef	SPISCOPE_SCOPC
	...
	wbscopc #(
		...
		// {{{
		.i_data_clk(i_clk), .i_ce(1'b1),
		.i_trigger(oled_debug[31]), .i_data(oled_debug[30:0]),
		.i_wb_clk(i_clk),
		.i_wb_cyc(wb32_spiscope_cyc), .i_wb_stb(wb32_spiscope_stb), .i_wb_we(wb32_spiscope_we),
			.i_wb_addr(wb32_spiscope_addr[1-1:0]),
			.i_wb_data(wb32_spiscope_data), // 32 bits wide
			.i_wb_sel(wb32_spiscope_sel),  // 32/8 bits wide
		.o_wb_stall(wb32_spiscope_stall),.o_wb_ack(wb32_spiscope_ack), .o_wb_data(wb32_spiscope_idata),
		.o_interrupt(spiscope_int)
		// }}}
	);
...
`else	// SPISCOPE_SCOPC
	...
	//
	// In the case that there is no wb32_spiscope peripheral
	// responding on the wb32 bus
	assign	wb32_spiscope_ack   = 1'b0;
	assign	wb32_spiscope_err   = (wb32_spiscope_stb);
	assign	wb32_spiscope_stall = 0;
	assign	wb32_spiscope_idata = 0;

	// }}}
	// Null interrupt definitions
	// {{{
	assign	spiscope_int = 1'b0;	// spiscope.INT.OLEDSCOPE.WIRE
	// }}}
	// }}}
...
`ifdef	ROTARY_ACCESS
	...
	u_rotary (
		.i_clk(i_clk),
		.i_reset(i_reset),
		.i_wb_cyc(wb32_rotary_cyc), .i_wb_stb(wb32_rotary_stb), .i_wb_we(wb32_rotary_we),
			.i_wb_data(wb32_rotary_data), // 32 bits wide
			.i_wb_sel(wb32_rotary_sel),  // 32/8 bits wide
		.o_wb_stall(wb32_rotary_stall),.o_wb_ack(wb32_rotary_ack), .o_wb_data(wb32_rotary_idata),
		.i_a(i_rotary_a), .i_b(i_rotary_b)
	);
	// }}}
`else	// ROTARY_ACCESS
	// {{{
...
`endif	// SDRAM_ACCESS
	...
	wbdown #(
		// {{{
		// Slave bus address width: 26
		// Slave address width    : 11
		// Master address width   : 13
		.ADDRESS_WIDTH(11+$clog2(128/8)),
		.WIDE_DW(128),
		.SMALL_DW(32),
		.OPT_LITTLE_ENDIAN(1'b0),
		.OPT_LOWLOGIC(1'b0)
		...
		.i_waddr( wbwide_crossbus_addr[11-1:0]),
		...
		.o_saddr( wb32_crossbus_addr[13-1:0]),
