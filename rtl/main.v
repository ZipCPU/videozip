...
// }}}
	...
	wire	edidscope_int;	// edidscope.INT.I2CSCOPE.WIRE
...
// }}}
	...
	// Verilator lint_on UNUSED
	// Wishbone definitions for bus wb32, component edidscope
	// Verilator lint_off UNUSED
	wire		wb32_edidscope_cyc, wb32_edidscope_stb, wb32_edidscope_we;
	wire	[11:0]	wb32_edidscope_addr;
	wire	[31:0]	wb32_edidscope_data;
	wire	[3:0]	wb32_edidscope_sel;
	wire		wb32_edidscope_stall, wb32_edidscope_ack, wb32_edidscope_err;
	wire	[31:0]	wb32_edidscope_idata;
	// Verilator lint_on UNUSED
	...
	assign	wb32_edidscope_err= 1'b0;
	...
	wbxbar #(
		...
		.SLAVE_ADDR({
			...
			{ 12'h400 }, //       cfg: 0x1000
			{ 12'h380 }, //      uart: 0x0e00
			{ 12'h300 }, //  zipscope: 0x0c00
			{ 12'h280 }, //  vidscope: 0x0a00
			{ 12'h200 }, // sdioscope: 0x0800
			{ 12'h180 }, // edidscope: 0x0600
...
`ifdef	EDIDSCOPE_SCOPC
	...
	wbscopc #(
		...
		// {{{
		.i_data_clk(i_clk), .i_ce(1'b1),
		.i_trigger(edid_debug[31]), .i_data(edid_debug[30:0]),
		.i_wb_clk(i_clk),
		.i_wb_cyc(wb32_edidscope_cyc), .i_wb_stb(wb32_edidscope_stb), .i_wb_we(wb32_edidscope_we),
			.i_wb_addr(wb32_edidscope_addr[1-1:0]),
			.i_wb_data(wb32_edidscope_data), // 32 bits wide
			.i_wb_sel(wb32_edidscope_sel),  // 32/8 bits wide
		.o_wb_stall(wb32_edidscope_stall),.o_wb_ack(wb32_edidscope_ack), .o_wb_data(wb32_edidscope_idata),
		.o_interrupt(edidscope_int)
		// }}}
	);
	// }}}
`else	// EDIDSCOPE_SCOPC
	// {{{
	// Null bus slave
	// {{{

	//
	// In the case that there is no wb32_edidscope peripheral
	// responding on the wb32 bus
	assign	wb32_edidscope_ack   = 1'b0;
	assign	wb32_edidscope_err   = (wb32_edidscope_stb);
	assign	wb32_edidscope_stall = 0;
	assign	wb32_edidscope_idata = 0;

	// }}}
	// Null interrupt definitions
	// {{{
	assign	edidscope_int = 1'b0;	// edidscope.INT.I2CSCOPE.WIRE
	// }}}
	// }}}
`endif	// EDIDSCOPE_SCOPC
