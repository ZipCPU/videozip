...
`define	ENETRX_SCOPE
	...
	// from
`ifdef	FLASH_ACCESS
	localparam	RESET_ADDRESS = 341835776;
`else
	localparam	RESET_ADDRESS = 318767104;
`endif
	//
...
`include "builddate.v"
	...
	assign	   buildtime_sel = ((wb_sio_sel)&&(wb_addr[ 4: 0] ==  5'h00));  // 0x0000000
	assign	      buserr_sel = ((wb_sio_sel)&&(wb_addr[ 4: 0] ==  5'h01));  // 0x0000004
	assign	      buspic_sel = ((wb_sio_sel)&&(wb_addr[ 4: 0] ==  5'h02));  // 0x0000008
	assign	   clkhdmiin_sel = ((wb_sio_sel)&&(wb_addr[ 4: 0] ==  5'h03));  // 0x000000c
	assign	  clkhdmiout_sel = ((wb_sio_sel)&&(wb_addr[ 4: 0] ==  5'h04));  // 0x0000010
	assign	      genclk_sel = ((wb_sio_sel)&&(wb_addr[ 4: 0] ==  5'h05));  // 0x0000014
	assign	 genclk_test_sel = ((wb_sio_sel)&&(wb_addr[ 4: 0] ==  5'h06));  // 0x0000018
	assign	        gpio_sel = ((wb_sio_sel)&&(wb_addr[ 4: 0] ==  5'h07));  // 0x000001c
	assign	hdmi_scope_frame_offset_sel = ((wb_sio_sel)&&(wb_addr[ 4: 0] ==  5'h08));  // 0x0000020
	assign	    netrxctr_sel = ((wb_sio_sel)&&(wb_addr[ 4: 0] ==  5'h09));  // 0x0000024
	assign	    nettxctr_sel = ((wb_sio_sel)&&(wb_addr[ 4: 0] ==  5'h0a));  // 0x0000028
	assign	    pwrcount_sel = ((wb_sio_sel)&&(wb_addr[ 4: 0] ==  5'h0b));  // 0x000002c
	assign	     rtcdate_sel = ((wb_sio_sel)&&(wb_addr[ 4: 0] ==  5'h0c));  // 0x0000030
	assign	        spio_sel = ((wb_sio_sel)&&(wb_addr[ 4: 0] ==  5'h0d));  // 0x0000034
	assign	  subseconds_sel = ((wb_sio_sel)&&(wb_addr[ 4: 0] ==  5'h0e));  // 0x0000038
	assign	      sysclk_sel = ((wb_sio_sel)&&(wb_addr[ 4: 0] ==  5'h0f));  // 0x000003c
	assign	     version_sel = ((wb_sio_sel)&&(wb_addr[ 4: 0] ==  5'h10));  // 0x0000040
	assign	         gck_sel = ((wb_dio_sel)&&((wb_addr[ 7: 3] &  5'h1f) ==  5'h00));  // 0x0000000 - 0x000000f
	assign	        mous_sel = ((wb_dio_sel)&&((wb_addr[ 7: 3] &  5'h1f) ==  5'h01));  // 0x0000020 - 0x000002f
	assign	         rtc_sel = ((wb_dio_sel)&&((wb_addr[ 7: 3] &  5'h1f) ==  5'h02));  // 0x0000040 - 0x000004f
	assign	         gtb_sel = ((wb_dio_sel)&&((wb_addr[ 7: 3] &  5'h1f) ==  5'h03));  // 0x0000060 - 0x000007f
	assign	      hdmiin_sel = ((wb_dio_sel)&&((wb_addr[ 7: 3] &  5'h1e) ==  5'h04));  // 0x0000080 - 0x00000bf
	assign	        edin_sel = ((wb_dio_sel)&&((wb_addr[ 7: 3] &  5'h18) ==  5'h08));  // 0x0000100 - 0x00001ff
	assign	       edout_sel = ((wb_dio_sel)&&((wb_addr[ 7: 3] &  5'h10) ==  5'h10));  // 0x0000200 - 0x00003ff
	assign	    flashcfg_sel = ((wb_addr[27:22] &  6'h3f) ==  6'h01); // 0x1000000
	assign	   enetscope_sel = ((wb_addr[27:22] &  6'h3f) ==  6'h02); // 0x2000000 - 0x2000007
	assign	    flashdbg_sel = ((wb_addr[27:22] &  6'h3f) ==  6'h03); // 0x3000000 - 0x3000007
	assign	   mdioscope_sel = ((wb_addr[27:22] &  6'h3f) ==  6'h04); // 0x4000000 - 0x4000007
	assign	        pmic_sel = ((wb_addr[27:22] &  6'h3f) ==  6'h05); // 0x5000000 - 0x5000007
	assign	   scop_edid_sel = ((wb_addr[27:22] &  6'h3f) ==  6'h06); // 0x6000000 - 0x6000007
	assign	scope_hdmiin_sel = ((wb_addr[27:22] &  6'h3f) ==  6'h07); // 0x7000000 - 0x7000007
	assign	scope_sdcard_sel = ((wb_addr[27:22] &  6'h3f) ==  6'h08); // 0x8000000 - 0x8000007
	assign	    zipscope_sel = ((wb_addr[27:22] &  6'h3f) ==  6'h09); // 0x9000000 - 0x9000007
	assign	        gpsu_sel = ((wb_addr[27:22] &  6'h3f) ==  6'h0a); // 0xa000000 - 0xa00000f
	assign	      sdcard_sel = ((wb_addr[27:22] &  6'h3f) ==  6'h0b); // 0xb000000 - 0xb00000f
	assign	        uart_sel = ((wb_addr[27:22] &  6'h3f) ==  6'h0c); // 0xc000000 - 0xc00000f
	assign	        netp_sel = ((wb_addr[27:22] &  6'h3f) ==  6'h0d); // 0xd000000 - 0xd00001f
	assign	         cfg_sel = ((wb_addr[27:22] &  6'h3f) ==  6'h0e); // 0xe000000 - 0xe00007f
	assign	        mdio_sel = ((wb_addr[27:22] &  6'h3f) ==  6'h0f); // 0xf000000 - 0xf00007f
	assign	      wb_sio_sel = ((wb_addr[27:22] &  6'h3f) ==  6'h10); // 0x10000000 - 0x1000007f
//x2	Was a master bus as well
	assign	      wb_dio_sel = ((wb_addr[27:22] &  6'h3f) ==  6'h11); // 0x11000000 - 0x110003ff
//x2	Was a master bus as well
	assign	        netb_sel = ((wb_addr[27:22] &  6'h3f) ==  6'h12); // 0x12000000 - 0x12007fff
	assign	       bkram_sel = ((wb_addr[27:22] &  6'h3f) ==  6'h13); // 0x13000000 - 0x130fffff
	assign	       flash_sel = ((wb_addr[27:22] &  6'h3f) ==  6'h14); // 0x14000000 - 0x14ffffff
...
//x2	Was a master bus as well
	...
	always @(posedge i_clk)
		case({		flashcfg_ack,
				...
				flash_ack,
				xpand_ack})
			21'b000000000000000000000: wb_many_ack <= 1'b0;
			21'b100000000000000000000: wb_many_ack <= 1'b0;
			21'b010000000000000000000: wb_many_ack <= 1'b0;
			21'b001000000000000000000: wb_many_ack <= 1'b0;
			21'b000100000000000000000: wb_many_ack <= 1'b0;
			21'b000010000000000000000: wb_many_ack <= 1'b0;
			21'b000001000000000000000: wb_many_ack <= 1'b0;
			21'b000000100000000000000: wb_many_ack <= 1'b0;
			21'b000000010000000000000: wb_many_ack <= 1'b0;
			21'b000000001000000000000: wb_many_ack <= 1'b0;
			21'b000000000100000000000: wb_many_ack <= 1'b0;
			21'b000000000010000000000: wb_many_ack <= 1'b0;
			21'b000000000001000000000: wb_many_ack <= 1'b0;
			21'b000000000000100000000: wb_many_ack <= 1'b0;
			21'b000000000000010000000: wb_many_ack <= 1'b0;
			21'b000000000000001000000: wb_many_ack <= 1'b0;
			21'b000000000000000100000: wb_many_ack <= 1'b0;
			21'b000000000000000010000: wb_many_ack <= 1'b0;
			21'b000000000000000001000: wb_many_ack <= 1'b0;
			21'b000000000000000000100: wb_many_ack <= 1'b0;
			21'b000000000000000000010: wb_many_ack <= 1'b0;
			21'b000000000000000000001: wb_many_ack <= 1'b0;
	...
	always	@(posedge i_clk)
	casez( wb_addr[4:0] )
		5'h0: r_wb_sio_data <= buildtime_data;
		5'h1: r_wb_sio_data <= buserr_data;
		5'h2: r_wb_sio_data <= buspic_data;
		5'h3: r_wb_sio_data <= clkhdmiin_data;
		5'h4: r_wb_sio_data <= clkhdmiout_data;
		5'h5: r_wb_sio_data <= genclk_data;
		5'h6: r_wb_sio_data <= genclk_test_data;
		5'h7: r_wb_sio_data <= gpio_data;
		5'h8: r_wb_sio_data <= hdmi_scope_frame_offset_data;
		5'h9: r_wb_sio_data <= netrxctr_data;
		5'ha: r_wb_sio_data <= nettxctr_data;
		5'hb: r_wb_sio_data <= pwrcount_data;
		5'hc: r_wb_sio_data <= rtcdate_data;
		5'hd: r_wb_sio_data <= spio_data;
		5'he: r_wb_sio_data <= subseconds_data;
		5'hf: r_wb_sio_data <= sysclk_data;
	...
	casez(wb_addr[7:3])
		...
		5'b01_???: r_wb_dio_bus_select <= 3'd5;
		5'b1?_???: r_wb_dio_bus_select <= 3'd6;
	...
	casez(r_wb_dio_bus_select)
		...
		3'd2: r_wb_dio_data <= rtc_data;
		3'd3: r_wb_dio_data <= gtb_data;
		3'd4: r_wb_dio_data <= hdmiin_data;
		3'd5: r_wb_dio_data <= edin_data;
	...
	// connected to them.
	//
	reg [4:0]	r_wb_bus_select;
	always	@(posedge i_clk)
	if (wb_stb && ! wb_stall)
		casez(wb_addr[27:22])
			// 3f000000 & 01000000, flashcfg
			6'b00_0001: r_wb_bus_select <= 5'd0;
			// 3f000000 & 02000000, enetscope
			6'b00_0010: r_wb_bus_select <= 5'd1;
			// 3f000000 & 03000000, flashdbg
			6'b00_0011: r_wb_bus_select <= 5'd2;
			// 3f000000 & 04000000, mdioscope
			6'b00_0100: r_wb_bus_select <= 5'd3;
			// 3f000000 & 05000000, pmic
			6'b00_0101: r_wb_bus_select <= 5'd4;
			// 3f000000 & 06000000, scop_edid
			6'b00_0110: r_wb_bus_select <= 5'd5;
			// 3f000000 & 07000000, scope_hdmiin
			6'b00_0111: r_wb_bus_select <= 5'd6;
			// 3f000000 & 08000000, scope_sdcard
			6'b00_1000: r_wb_bus_select <= 5'd7;
			// 3f000000 & 09000000, zipscope
			6'b00_1001: r_wb_bus_select <= 5'd8;
			// 3f000000 & 0a000000, gpsu
			6'b00_1010: r_wb_bus_select <= 5'd9;
			// 3f000000 & 0b000000, sdcard
			6'b00_1011: r_wb_bus_select <= 5'd10;
			// 3f000000 & 0c000000, uart
			6'b00_1100: r_wb_bus_select <= 5'd11;
			// 3f000000 & 0d000000, netp
			6'b00_1101: r_wb_bus_select <= 5'd12;
			// 3f000000 & 0e000000, cfg
			6'b00_1110: r_wb_bus_select <= 5'd13;
			// 3f000000 & 0f000000, mdio
			6'b00_1111: r_wb_bus_select <= 5'd14;
			// 3f000000 & 10000000, wb_sio
			6'b01_0000: r_wb_bus_select <= 5'd15;
			// 3f000000 & 11000000, wb_dio
			6'b01_0001: r_wb_bus_select <= 5'd16;
			// 3f000000 & 12000000, netb
			6'b01_0010: r_wb_bus_select <= 5'd17;
			// 3f000000 & 13000000, bkram
			6'b01_0011: r_wb_bus_select <= 5'd18;
			// 3f000000 & 14000000, flash
			6'b01_0100: r_wb_bus_select <= 5'd19;
			// 20000000 & 20000000, xpand
			6'b1?_????: r_wb_bus_select <= 5'd20;
			default: begin end
		endcase

	always @(posedge i_clk)
	casez(r_wb_bus_select)
		5'd0: wb_idata <= flashcfg_data;
		5'd1: wb_idata <= enetscope_data;
		5'd2: wb_idata <= flashdbg_data;
		5'd3: wb_idata <= mdioscope_data;
		5'd4: wb_idata <= pmic_data;
		5'd5: wb_idata <= scop_edid_data;
		5'd6: wb_idata <= scope_hdmiin_data;
		5'd7: wb_idata <= scope_sdcard_data;
		5'd8: wb_idata <= zipscope_data;
		5'd9: wb_idata <= gpsu_data;
		5'd10: wb_idata <= sdcard_data;
		5'd11: wb_idata <= uart_data;
		5'd12: wb_idata <= netp_data;
		5'd13: wb_idata <= cfg_data;
		5'd14: wb_idata <= mdio_data;
		5'd15: wb_idata <= wb_sio_data;
		5'd16: wb_idata <= wb_dio_data;
		5'd17: wb_idata <= netb_data;
		5'd18: wb_idata <= bkram_data;
		5'd19: wb_idata <= flash_data;
		5'd20: wb_idata <= xpand_data;
...
`else	// MDIOSCOPE_SCOPE
	...
	assign	mdioscope_ack   = (wb_stb) && (mdioscope_sel);
...
`ifdef	NETSCOPE_SCOPE
   	wbscope #(.LGMEM(9),
		.SYNCHRONOUS(0))
	enetscopei(netp_debug_clk, 1'b1, netp_dbg_trigger, netp_debug,
...
`else	// ETHERNET_ACCESS
	...
	assign	netp_ack   = (wb_stb) && (netp_sel);
	assign	netp_stall = 0;
	assign	netp_data  = 0;
...
`ifdef	NETRXCLK_ACCESS
	clkcounter clknetrxctrctr(i_clk, ck_pps, i_net_rx_clk, netrxctr_data);
	always @(posedge i_clk)
...
`else	// ARBITRARY_CLOCK_GENERATOR_ACCESS
	...
	assign	genclk_ack   = (wb_stb) && (genclk_sel);
...
`ifdef	NETTXCLK_ACCESS
	clkcounter clknettxctrctr(i_clk, ck_pps, i_clk_125mhz, nettxctr_data);
	always @(posedge i_clk)
