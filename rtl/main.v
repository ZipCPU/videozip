...
//
// CmdLine:	autofpga -d -o . allclocks.txt genclk.txt netclockctr.txt global.txt icape.txt crossbus.txt version.txt buserr.txt pwrcount.txt rtccount.txt spio.txt gpio.txt vadj33.txt rtclight.txt rtcdate.txt exconsole.txt wbuuart.txt bkram.txt flash.txt flashcfg.txt sdram.txt zipmaster.txt mdio.txt meganet.txt protocols.txt sdio.txt cpuscope.txt mem_bkram_only.txt mem_flash_bkram.txt xdc.txt clkcounter.txt i2ccpu.txt
//
...
// }}}
	...
	wire	[10:0]	wb32_netclockctr_addr;
	...
	2'd2: r_wb32_dio_data <= wb32_rtc_idata;
	...
	assign	wb32_rtc_stb = wb32_dio_stb && ((wb32_dio_addr[ 4: 2] &  3'h6) ==  3'h2);  // 0x020 - 0x03f
	...
	//
	wbxbar #(
		.NM(1), .NS(7), .AW(11), .DW(32),
		.SLAVE_ADDR({
			// Address width    = 11
			// Address LSBs     = 2
			// Slave name width = 8
			{ 11'h400 }, //     mdio: 0x1000
			{ 11'h380 }, // wb32_dio: 0x0e00
			{ 11'h300 }, //      net: 0x0c00
			{ 11'h280 }, //      cfg: 0x0a00
			{ 11'h200 }, //     uart: 0x0800
...
`endif	// MEGANET_ACCESS
	...
	wbdown #(
		// {{{
		// Slave bus address width: 26
		// Slave address width    : 9
		// Master address width   : 11
		.ADDRESS_WIDTH(9+$clog2(128/8)),
		.WIDE_DW(128),
		.SMALL_DW(32),
		.OPT_LITTLE_ENDIAN(1'b0),
		.OPT_LOWLOGIC(1'b0)
		...
		.i_waddr( wbwide_crossbus_addr[9-1:0]),
