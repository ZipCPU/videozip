...
// DO NOT EDIT THIS FILE!
//
// CmdLine:	../../../autofpga/trunk/sw/autofpga ../../../autofpga/trunk/sw/autofpga -o . global.txt bkram.txt buserr.txt clkcounter.txt dlyarbiter.txt flash.txt gpio.txt icape.txt mdio.txt pic.txt pwrcount.txt rtcdate.txt rtcgps.txt spio.txt version.txt wbmouse.txt wboledbw.txt wbpmic.txt wbuconsole.txt zipmaster.txt gps.txt sdspi.txt hdmi.txt xdc.txt xpander.txt sdvidram.txt genclk.txt
//
...
// check
	...
	// from
	localparam	RESET_ADDRESS = 32'h1c400000;
	//
...
//
	...
	wire		sdr_cyc, sdr_stb, sdr_we, sdr_stall, sdr_err, 	sdr_none_sel;
	reg		sdr_many_ack;
	wire	[24:0]	sdr_addr;
	wire	[127:0]	sdr_data;
	reg	[127:0]	sdr_idata;
	...
	assign	        pmic_sel = ((wb_addr[27:23] &  5'h1f) ==  5'h01);
	assign	   scop_edid_sel = ((wb_addr[27:23] &  5'h1f) ==  5'h02);
	assign	scope_hdmiin_sel = ((wb_addr[27:23] &  5'h1f) ==  5'h03);
	assign	scope_sdcard_sel = ((wb_addr[27:23] &  5'h1f) ==  5'h04);
	assign	       flctl_sel = ((wb_addr[27:23] &  5'h1f) ==  5'h05);
	assign	        gpsu_sel = ((wb_addr[27:23] &  5'h1f) ==  5'h06);
	assign	      sdcard_sel = ((wb_addr[27:23] &  5'h1f) ==  5'h07);
	assign	        uart_sel = ((wb_addr[27:23] &  5'h1f) ==  5'h08);
	assign	      wb_sio_sel = ((wb_addr[27:23] &  5'h1f) ==  5'h09);
//x2	Was a master bus as well
	assign	         cfg_sel = ((wb_addr[27:23] &  5'h1f) ==  5'h0a);
	assign	        mdio_sel = ((wb_addr[27:23] &  5'h1f) ==  5'h0b);
	assign	      wb_dio_sel = ((wb_addr[27:23] &  5'h1f) ==  5'h0c);
//x2	Was a master bus as well
	assign	       bkram_sel = ((wb_addr[27:23] &  5'h1f) ==  5'h0d);
	assign	       flash_sel = ((wb_addr[27:23] &  5'h1f) ==  5'h0e);
	assign	       xpand_sel = ((wb_addr[27:23] &  5'h10) ==  5'h10);
//x2	Was a master bus as well
	//
...
//x2	Was a master bus as well
	...
	always @(posedge i_clk)
		case({		pmic_ack,
				...
				flash_ack,
				xpand_ack})
			15'b000000000000000: wb_many_ack <= 1'b0;
			15'b100000000000000: wb_many_ack <= 1'b0;
			15'b010000000000000: wb_many_ack <= 1'b0;
			15'b001000000000000: wb_many_ack <= 1'b0;
			15'b000100000000000: wb_many_ack <= 1'b0;
			15'b000010000000000: wb_many_ack <= 1'b0;
			15'b000001000000000: wb_many_ack <= 1'b0;
			15'b000000100000000: wb_many_ack <= 1'b0;
			15'b000000010000000: wb_many_ack <= 1'b0;
			15'b000000001000000: wb_many_ack <= 1'b0;
			15'b000000000100000: wb_many_ack <= 1'b0;
			15'b000000000010000: wb_many_ack <= 1'b0;
			15'b000000000001000: wb_many_ack <= 1'b0;
			15'b000000000000100: wb_many_ack <= 1'b0;
			15'b000000000000010: wb_many_ack <= 1'b0;
			15'b000000000000001: wb_many_ack <= 1'b0;
	...
	always	@(posedge i_clk)
		...
		casez( wb_addr[3:0] )
			...
			4'h9: r_wb_sio_data <= pwrcount_data;
			4'ha: r_wb_sio_data <= spio_data;
	...
	begin
		casez({		pmic_ack,
				...
				bkram_ack,
				flash_ack	})
			14'b1?????????????: wb_idata <= pmic_data;
			14'b01????????????: wb_idata <= scop_edid_data;
			14'b001???????????: wb_idata <= scope_hdmiin_data;
			14'b0001??????????: wb_idata <= scope_sdcard_data;
			14'b00001?????????: wb_idata <= flctl_data;
			14'b000001????????: wb_idata <= gpsu_data;
			14'b0000001???????: wb_idata <= sdcard_data;
			14'b00000001??????: wb_idata <= uart_data;
			14'b000000001?????: wb_idata <= wb_sio_data;
			14'b0000000001????: wb_idata <= cfg_data;
			14'b00000000001???: wb_idata <= mdio_data;
			14'b000000000001??: wb_idata <= wb_dio_data;
			14'b0000000000001?: wb_idata <= bkram_data;
			14'b00000000000001: wb_idata <= flash_data;
...
`else	// SDRAM_ACCESS
	...
	always @(posedge i_clk_200mhz)	r_sdram_ack <= (sdr_stb)&&(sdram_sel);
...
`ifdef	BUS_DELAY_NEEDED
	busdelay #(28)	wbu_dwbi_delay(i_clk,
		wbu_dwbi_cyc, wbu_dwbi_stb, wbu_dwbi_we, wbu_dwbi_addr, wbu_dwbi_odata, wbu_dwbi_sel,
