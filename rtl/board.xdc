...
set_max_delay -datapath_only -from [get_cells -hier -filter {NAME=~ thedesign/u_sdio/u_sdcmd/cmd_tristate*}] -to [get_cells -hier -filter {NAME=~ u_sdio_frontend/GEN_WIDE_IO.cmd_serdes/u_oserdes*}] 4.0
