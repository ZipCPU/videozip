...
static volatile WBSCOPE *const _zipscope = ((WBSCOPE *)100663296);
#ifdef	SDSPI_SCOPE
#define	_BOARD_HAS_SDSPI_SCOPE
static volatile WBSCOPE *const _scope_sdcard = ((WBSCOPE *)0x05000000);
#endif	// SDSPI_SCOPE
...
#define	_BOARD_HAS_FLASHCTL
static volatile unsigned * const _flctl = ((unsigned *)(0x07000000));
...
#define	BUSPIC_HINSCOPE	BUSPIC(5)
#define	BUSPIC_SDCARD	BUSPIC(6)
#define	BUSPIC_SPIO	BUSPIC(7)
