...
static volatile WBSCOPE *const _edidslvscope = ((WBSCOPE *)0x08000800);
...
#define	ALTPIC_EDIDSLVSCOPE	ALTPIC(8)
#define	ALTPIC_CPUSCOPE	ALTPIC(9)
#define	ALTPIC_VIDSCOPE	ALTPIC(10)
