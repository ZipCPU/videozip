...
//	device(s).
//
//	Unlike the txfns* functions, these are for reading from the serial
//	port
//
...
extern	int	rxchr(void);
extern	void	rxline(char *str, int ln);
extern	int	slen(const char *str);
extern	int	stoi(const char *str);
extern	int	isdig(const char chr);
