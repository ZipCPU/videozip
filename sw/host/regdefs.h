...
// I2C Controller registers
#define	R_I2CCPU          	0x08001820	// 08001820, wbregs names: I2CCPU, I2CCPU_CTRL, I2CCPUCTRL
#define	R_I2CCPU_OVW      	0x08001824	// 08001820, wbregs names: I2CCPU_OVW, I2CCPU_OVERRIDE
#define	R_I2CCPU_ADDR     	0x08001828	// 08001820, wbregs names: I2CCPU_ADDR, I2CCPU_ADDRESS
#define	R_I2CCPU_CKCOUNT  	0x0800182c	// 08001820, wbregs names: I2CCPUCLK, I2CCPU_CKCOUNT
#define	R_OLED            	0x08001840	// 08001840, wbregs names: OLED
#define	R_OLED_OV         	0x08001844	// 08001840, wbregs names: OLEDOV
#define	R_OLED_ADDR       	0x08001848	// 08001840, wbregs names: OLEDADDR
#define	R_OLED_CLK        	0x0800184c	// 08001840, wbregs names: OLEDCLK
// RTC clock registers
#define	R_CLOCK           	0x08001860	// 08001860, wbregs names: CLOCK
#define	R_TIMER           	0x08001864	// 08001860, wbregs names: TIMER
#define	R_STOPWATCH       	0x08001868	// 08001860, wbregs names: STOPWATCH
#define	R_CKALARM         	0x0800186c	// 08001860, wbregs names: ALARM, CKALARM
#define	R_BLDTIME         	0x08001880	// 08001880, wbregs names: BLDTIME, BUILDTIME
#define	R_BUSERR          	0x08001884	// 08001884, wbregs names: BUSERR
#define	R_GENCLK          	0x08001888	// 08001888, wbregs names: GENCLK
// SYSCLK Clock Counter (measures clock speed)
#define	R_GENCLKFB        	0x0800188c	// 0800188c, wbregs names: GENCLKFB
#define	R_GPIO            	0x08001890	// 08001890, wbregs names: GPIO, GPI, GPO
// Network RX clock counter (measures clock speed)
#define	R_NETCLOCKCTR     	0x08001894	// 08001894, wbregs names: NETCLOCKCTR
// Network TX clock counter (measures clock speed)
#define	R_NETTXCLK        	0x08001898	// 08001898, wbregs names: NETTXCLK
#define	R_PWRCOUNT        	0x0800189c	// 0800189c, wbregs names: PWRCOUNT
// rotary registers
#define	R_ROTARY          	0x080018a0	// 080018a0, wbregs names: ROTARY
#define	R_RTCCOUNT        	0x080018a4	// 080018a4, wbregs names: RTCCOUNT
#define	R_RTCDATE         	0x080018a8	// 080018a8, wbregs names: RTCDATE, DATE
#define	R_SPIO            	0x080018ac	// 080018ac, wbregs names: SPIO
// SYSCLK Clock Counter (measures clock speed)
#define	R_SYSCLK          	0x080018b0	// 080018b0, wbregs names: SYSCLK
#define	R_VERSION         	0x080018b4	// 080018b4, wbregs names: VERSION
