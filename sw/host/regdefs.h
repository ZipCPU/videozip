...
#define	R_I2CCPU          	0x08001800	// 08001800, wbregs names: I2CCPU, I2CCPU_CTRL, I2CCPUCTRL
#define	R_I2CCPU_OVW      	0x08001804	// 08001800, wbregs names: I2CCPU_OVW, I2CCPU_OVERRIDE
#define	R_I2CCPU_ADDR     	0x08001808	// 08001800, wbregs names: I2CCPU_ADDR, I2CCPU_ADDRESS
#define	R_I2CCPU_CKCOUNT  	0x0800180c	// 08001800, wbregs names: I2CCPUCLK, I2CCPU_CKCOUNT
#define	R_I2CDMA          	0x08001810	// 08001810, wbregs names: I2CDMA
#define	R_I2CDMA_ADDR     	0x08001814	// 08001810, wbregs names: I2CDMAADDR
#define	R_I2CDMA_BASE     	0x08001818	// 08001810, wbregs names: I2CDMABASE
#define	R_I2CDMA_LEN      	0x0800181c	// 08001810, wbregs names: I2CDMALEN
// RTC clock registers
#define	R_CLOCK           	0x08001820	// 08001820, wbregs names: CLOCK
#define	R_TIMER           	0x08001824	// 08001820, wbregs names: TIMER
#define	R_STOPWATCH       	0x08001828	// 08001820, wbregs names: STOPWATCH
#define	R_CKALARM         	0x0800182c	// 08001820, wbregs names: ALARM, CKALARM
#define	R_BLDTIME         	0x08001840	// 08001840, wbregs names: BLDTIME, BUILDTIME
#define	R_BUSERR          	0x08001844	// 08001844, wbregs names: BUSERR
#define	R_GENCLK          	0x08001848	// 08001848, wbregs names: GENCLK
// SYSCLK Clock Counter (measures clock speed)
#define	R_GENCLKFB        	0x0800184c	// 0800184c, wbregs names: GENCLKFB
#define	R_GPIO            	0x08001850	// 08001850, wbregs names: GPIO, GPI, GPO
// Network RX clock counter (measures clock speed)
#define	R_NETCLOCKCTR     	0x08001854	// 08001854, wbregs names: NETCLOCKCTR
// Network TX clock counter (measures clock speed)
#define	R_NETTXCLK        	0x08001858	// 08001858, wbregs names: NETTXCLK
#define	R_PWRCOUNT        	0x0800185c	// 0800185c, wbregs names: PWRCOUNT
#define	R_RTCCOUNT        	0x08001860	// 08001860, wbregs names: RTCCOUNT
#define	R_RTCDATE         	0x08001864	// 08001864, wbregs names: RTCDATE, DATE
#define	R_SPIO            	0x08001868	// 08001868, wbregs names: SPIO
// SYSCLK Clock Counter (measures clock speed)
#define	R_SYSCLK          	0x0800186c	// 0800186c, wbregs names: SYSCLK
#define	R_VERSION         	0x08001870	// 08001870, wbregs names: VERSION
